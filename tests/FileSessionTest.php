...
class FileSessionTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        Session\Configuration::set(['start_options' => ['save_path' => $this->session_path]]);
    }
    ...
    public function test_that_push_adds_a_value_to_the_bottom_of_specified_key_value()
    {
        ...
        $this->assertSame($_SESSION, [Session::DEFAULT_SEGMENT => [Session::SESSION_INDEX => ['name' => ['1st', '2nd', '3rd']]]]);
    }
    ...
    public function test_the_pop_without_back_argument_removes_the_top_values_of_specified_key_values()
    {
        ...
        $this->assertSame($_SESSION, [Session::DEFAULT_SEGMENT => [Session::SESSION_INDEX => ['name' => ['1st', '2nd']]]]);
    }
    ...
    public function test_the_pop_with_back_argument_removes_the_bottom_values_of_specified_key_values()
    {
        ...
        $this->assertSame($_SESSION, [Session::DEFAULT_SEGMENT => [Session::SESSION_INDEX => ['name' => ['3rd', '4th']]]]);
    }
    ...
    public function test_that_commit_saves_session()
    {
        ...
        $this->assertSame($_SESSION, [Session::DEFAULT_SEGMENT => [0 => ['foo' => $value]]]);
    }
    ...
    public function test_that_flash_data_can_be_committed()
    {
        ...
        $this->assertSame($_SESSION, [Session::DEFAULT_SEGMENT => [Session::FLASH_INDEX => ['first_name' => 'Foo', 'last_name' => 'Bar']]]);
    }
    ...
    public function test_that_getAll_without_namespace_argument_returns_all_array_in_current_session_segment()
    {
        ...
        $this->assertSame($_SESSION, [Session::DEFAULT_SEGMENT => [
            Session::SESSION_INDEX => ['name' => 'Foo', 'ages' => [10, 22]],
            Session::FLASH_INDEX => ['message' => 'just a flash']
        ]]);
    }
    ...
    public function test_that_commit_cascades()
    {
        ...
        $this->assertSame($_SESSION, [
            Session::DEFAULT_SEGMENT => [Session::SESSION_INDEX => ['name' => 'Bar'], Session::FLASH_INDEX => ['bar' => 'Hello']],
            'test-segment' => [Session::SESSION_INDEX => ['name' => 'Foo'], Session::FLASH_INDEX => ['bar' => 'Imani']]
        ]);
    }
    ...
    public function test_that_destroy_clear_all_session_data()
    {
        ...
        $expected[] = [
            Session::DEFAULT_SEGMENT => [
                Session::SESSION_INDEX => ['a' => 'A', 'b' => ['B', 'B']],
                Session::FLASH_INDEX => ['c' => 'C']
            ], 'hello' => [
                Session::SESSION_INDEX => ['a' => 'A', 'b' => ['B', 'B']],
                Session::FLASH_INDEX => ['c' => 'C']
            ]
    ...
    public function test_that_clear_clears_its_instance_data()
    {
        ...
        $this->assertSame($_SESSION, [
            Session::DEFAULT_SEGMENT => [Session::SESSION_INDEX => ['1st' => '1', '2nd' => '1']],
            'bar' => [],
            'foo' => [Session::SESSION_INDEX => ['1st' => '3', '2nd' => '3']],
            'foobar' => [],
            'user' => [Session::SESSION_INDEX => ['1st' => '5', '2nd' => '5']],
        ]);
    }
    ...
    public function test_that_session_data_without_encrypt_config_attribute_is_not_encrypted()
    {
        ...
        $this->assertStringEndsWith(serialize([Session::SESSION_INDEX => ['name' => 'FooBar']]), $session_raw_data);
    }
    ...
    public function test_that_session_data_with_encrypt_config_attribute_is_encrypted()
    {
        ...
        $set_get = new Session\SetGet(true, $key);

        $session_raw_data = file_get_contents($this->session_path . "sess_${id}");
        unlink($this->session_path . "sess_${id}");

        $this->assertStringEndsWith(serialize([Session::SESSION_INDEX => ['name' => 'FooBar']]), $set_get->get($session_raw_data));
    }

    public function test_encrypted_data_can_be_set_and_get()
    {
        $session = new Session(Session\Configuration::set(['encrypt_data' => true]));
        ...
        $expected[] = [
            Session::DEFAULT_SEGMENT => [
                Session::SESSION_INDEX => ['1' => 'one', '2' => ['two', 'two1']],
                Session::FLASH_INDEX => ['3' => 'three']
            ], 'seg' => [
                Session::SESSION_INDEX => ['1' => 'one', '2' => ['two', 'two1']],
                Session::FLASH_INDEX => ['3' => 'three']
            ]
